...
-- // STRIP HTML TAGS (dari XAL) //
local function StripTags(str)
    return string.gsub(str, "<[^>]+>", "")
end

-- // PARSE CHAT SERVER (dari XAL, lebih robust) //
-- Support format: "[Server]: Player obtained a Fish (181.7kg) with a 1 in 5K chance!"
